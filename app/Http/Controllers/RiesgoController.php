...
class RiesgoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.ZonasRiesgo.index')->with('message', 'Zona creada exitosamente');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.ZonasRiesgo.index')->with('success', 'Zona actualizada correctamente');
    }
