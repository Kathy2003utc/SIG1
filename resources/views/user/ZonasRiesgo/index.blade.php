...
<div class="container mt-4">
    <div class="mx-auto" style="max-width: 1200px;">
        <<a href="{{ route('user.ZonasRiesgo.create') }}" class="btn btn-success mb-3">
            <i class="fas fa-plus-circle"></i> Nueva Zona de riesgo
        </a>
    
        <a href="{{ route('user.reportes.zonas') }}" class="btn btn-outline-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center d-flex justify-content-center">
                            {{-- Botón Editar --}}
                            <a href="{{ route('user.ZonasRiesgo.edit', $riesgo->id) }}" class="btn btn-sm btn-primary me-2">
                                <i class="fas fa-edit"></i> Editar
                            </a>

                            {{-- Botón Eliminar --}}
                            <form action="{{ route('user.ZonasRiesgo.destroy', $riesgo->id) }}" method="POST" class="d-inline eliminar-formulario">
                                @csrf
                                @method('DELETE')
